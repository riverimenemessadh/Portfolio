...
const PROJECTS = [
  ...
  { id: 2, title: "StageConnect", desc: "StageConnect is a full-stack internship management platform connecting students, companies, and academic institutions. Students can browse and apply for internships, track their applications, and complete assessments. Companies can post offers, review applicants, and manage their interns. An admin panel provides full oversight of all platform activity. Built with Java EE (Servlets + JSP) and MySQL, deployed on Render with a cloud-hosted database on Railway.", tags: ["Java", "JSP", "MYSQL"], link: "https://stageconnect-0a4y.onrender.com", github: "https://github.com/riverimenemessadh/StagesPlatform", image: "/public/stageconnect.png" },
