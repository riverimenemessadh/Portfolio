      ...
      <motion.div style={{ y, opacity, maxWidth: 1200, width: "100%", boxSizing: "border-box", overflow: "hidden" }}>
        ...
        <div className="hero-layout">
          ...
          <div className="hero-left">
            ...
            {/* "Full Stack Developer" — mobile only, sits right under the name */}
            <motion.div
      ...
      <div className="about-grid">
        ...
        <SlideIn direction={-1} delay={0.1}>
          <motion.div className="about-photo-wrap"
            ...
            <div style={{ aspectRatio: "3/4", background: `linear-gradient(135deg, ${t.bg2} 0%, ${t.card} 100%)`, borderRadius: 6, overflow: "hidden", border: `1px solid ${t.border}`, position: "relative" }} className="about-photo-inner">
    ...
    <div style={{ background: t.bg, minHeight: "100svh", fontFamily: "'Syne', sans-serif", transition: "background 0.5s, color 0.5s", color: t.ink, overflowX: "hidden", width: "100%" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; max-width: 100%; }
        ...
        .about-photo-wrap .about-photo-inner {
