    ...
    <section id="about" ref={ref} className="section-padded" style={{ maxWidth: 1260, margin: "0 auto" }}>
      <div className="about-grid">
        ...
        <SlideIn direction={-1} delay={0.1}>
          <motion.div className="about-photo-wrap" style={{ position: "relative" }}>
            <div className="about-photo-inner" style={{ background: `linear-gradient(135deg, ${t.bg2} 0%, ${t.card} 100%)`, overflow: "hidden", border: `1px solid ${t.border}`, position: "relative" }}>
